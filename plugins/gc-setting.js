...
//REMOVE ADMINS BY 𝚂𝙸𝙻𝙴𝙽𝚃 𝙷𝙰𝙲𝙺𝙴𝚁 𝙼𝙳 OFFICIAL 
cmd({
...
if (users.length === 0 && text) {  
  ...
  // Pattern 1: Direct numbers like 923446068158  
...
async (conn, mek, m, {
    ...
    try {
        const ignoreJids = [
            "923281930258@s.whatsapp.net",  // JID to be ignored
            "923281930258@s.whatsapp.net"   // Another JID to be ignored
        ];
